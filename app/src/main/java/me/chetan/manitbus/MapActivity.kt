...
class MapActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        busList.forEach {
            ...
            path.color = ContextCompat.getColor(this,R.color.bus_path)
            path.outlinePaint.strokeWidth = 8f
            ...
            bus.setAnchor(Marker.ANCHOR_CENTER, Marker.ANCHOR_CENTER)
    ...
    fun highlightBus(){
        busMarker.forEach {
            if(it.id== highlight){
                it.icon = ContextCompat.getDrawable(this,R.drawable.baseline_directions_bus_24_highlight)
            }else{
